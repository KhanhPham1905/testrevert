...
const Veiclamtheoduan = () => {
  ...
  const onClick =(value)=>{
    ...
    router.push(`/trangchu/tim-viec-lam-freelancer-theo-du-an/${str}`)
                ...
                >
                  ...
                  <div className={styles.item_job02}>
                    ...
                    <div className={styles.text_item_job_02}>
                      ...
                      <div className={styles.info_user_job02}>
                        <p className={styles.it_info_user}>
                          <img
                            ...
                            alt=""
                          />
                          <span onClick={(e)=>{router.push('/trangchu/nha-tuyen-dung')}} style={{cursor:'pointer'}}>
                            <div
                      ...
                      <div className={styles.tag_nganh_nghe}  style={{cursor:"pointer"}} onClick={(e)=>{router.push('/tim-viec-lam-freelancer.html')}}>
                        <div>
