            ...
            <Row className={`${styles.cover_input} ${styles.position_r}`}>
                <Col span={24} >
                    <Form.Item 
                        label={
                            <div >
                                <p className={styles.title_input}>Đặt tên cụ thể cho công việc cần tuyển <span>*</span> </p> 
                            </div>
                        }
                        labelCol={{ span: 24 }}
                        wrapperCol={{ span: 24 }}
            ...
            <Row className={`${styles.cover_input} ${styles.position_r}`}>
                <Col span={24}>
                    <Form.Item
                        ...
                        label={
                            <p className={styles.title_input}>Kỹ năng yêu cầu Freelancer phải có <span>*</span></p>
                        }
                        labelCol={{ span: 24 }}
                        wrapperCol={{ span: 24 }}
                    >
                    ...
                    <Form.Item 
                        label={
                            <div className={styles.title_input_label}>
                                <p>Nội dung chi tiết, và các đầu việc cần Freelancer thực hiện <span style={{color:'#FF0000'}}>*</span></p>
...
export default Dangviectheoduan
